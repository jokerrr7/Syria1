...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ siria ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ siria ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ siria ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedawad10/DRAGON/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1765160742,1761565061,4,1726705278}   
...
if tonumber(user_id) == tonumber(1761565061) then  
var = 'روح قلب سوريا'
elseif tonumber(user_id) == tonumber(4) then
var = 'مطور السورس'  
elseif tonumber(user_id) == tonumber(1726705278) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐕𝐀𝐌𝐁𝐈𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✹ ")  
...
keyboard = {
{'المطور سوريا','مطور السورس'},
{'المبرمج ماديسون','قناة السورس'},
{'تويت','صراحه'},
}
end
...
os.execute('wget https://raw.githubusercontent.com/ahmedawad1000/vambir/main/DRAGON.lua')
...
if text == 'المطور سوريا' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝙳𝙴𝚅, 𝚂𝙸𝚁𝙸𝙰](t.me/SIRIA199)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝙳𝙴𝚅, 𝙾𝚁𝙰𝙱𝙸](t.me/DEV_ORABI)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'عرابي مطور السورس', url="t.me/SIRIA199"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝙲𝙷 ➪](t.me/SOURCE_SYRIA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SOURCE_SYRIA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل سورس', url="t.me/twasol6bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = {
  ...
  "ها يولا غيرت صورتك😉😂",
  "غيرت صورتطك ايي شفت وحده جديده 😹🌚",
  "غيرت صورتكك ايي اتخانقت انت والمظهه ؟😹🥺",
  "يجمدانن الصورهه الجديده ؟؟ 🥺🐣",
}
...
local Text = [[
 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐀𝐌𝐁𝐈𝐑 ♡
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐒𝐈𝐑𝐈𝐀 ߷',url="t.me/SIRIA199"}},
{{text = '𝐃𝐄𝐕 𝐎𝐑𝐀𝐁𝐈 𖢄',url="t.me/DEV_ORABI"}},
{{text = '𝐃𝐄𝐕 𝐀𝐇𝐌𝐄𝐃 ⚚', url="t.me/AAHMEED11"}},
{{text = '𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐕𝐀𝐌𝐁𝐈𝐑 🜢', url="t.me/SOURCE_SYRIA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

local checka =string.find(text, "شششش")
if checka then
Text = [[
...
local checka =string.find(text, "ههههه")
if checka then
Text = [[
...
local checka =string.find(text, "هاي")
if checka then
Text = [[
...
local checka =string.find(text, "بكرهك")
if checka then
Text = [[

[ لا يلا انا ال بموت فيك 😏😏]

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
local checka =string.find(text, "عيب")
if checka then
Text = [[
...
local checka =string.find(text, "طيب")
if checka then
Text = [[
...
local checka =string.find(text, "وه")
if checka then
Text = [[
...
local checka =string.find(text, "لول")
if checka then
Text = [[
...
if text == 'سوريا' or text == 'احمد سوريا' or text == 'مالك السورس' then 
local Text = [[ 
[𝙳𝙴𝚅, 𝚂𝙸𝚁𝙸𝙰](t.me/SIRIA199)
]] 
keyboard = {}  
...
if text == 'عرابي' or text == 'اخو سوريا' or text == 'مطور السورس' then 
local Text = [[ 
[𝙳𝙴𝚅, 𝙾𝚁𝙰𝙱𝙸](t.me/DEV_ORABI)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'عرابي مطور السورس' , url="t.me/DEV_ORABI"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'الجوكر' or text == 'جوكر' or text == 'مبرمج السورس' then 
local Text = [[ 
[𝙳𝙴𝚅, JOKER](t.me/eljo_ker_m)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'جوكر مبرمج السورس' , url="t.me/eljo_ker_m"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'منصب عند مين' or text == 'عاوز بوت' then
local Text = [[
𝐕𝐀𝐌𝐁𝐈𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✹ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مالك السورس',url="t.me/eljo_ker_m"}},
{{text = 'تواصل سورس', url="t.me/twasol6bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مبرمج جوكر', url="t.me/eljo_ker_m"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
وهذه بعض الالعاب المطتوره 🔥
]]
keyboard = {} keyboard.inline_keyboard = {
{{text =  '𝙳𝙴𝚅, 𝙾𝚁𝙰𝙱𝙸', url="t.me/DEV_ORABI"}}, 
...
{{text = '𝙳𝙴𝚅, 𝙰𝙷𝙼𝙴𝙳', url="t.me/AAHMEED11"}}, 
...
{{text = '𝙳𝙴𝚅, 𝚂𝙸𝚁𝙸', url="t.me/DEV_ORABI"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if result.sender_user_id_ == tonumber(4) then
send(msg.chat_id_, msg.id_, " ※ لا يمكنك حظر مطور السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1761565061) then
send(msg.chat_id_, msg.id_, " ※ لا يمكنك حظر المطور روح قلب سوريا \n")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedawad10/DRAGON/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedawad10/DRAGON/main/File_Bot/"..file)
if res == 200 then
...
' }\n'..' ※  الايدي بالصوره » { '..idph..
' }\n'..' ※  الرفع » { '..setadd..
' }\n'..' ※  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ siria ┉  ┉ ┉ ┉ ┉≫ٴ\n ※ قناة سورس سوريا ↓\n [🖨┇𝐕𝐀𝐌𝐁𝐈𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✹ ](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if text == 'مسح القوائم' and BasicConstructor(msg) then  
database:del(bot_id..'Constructor'..msg.chat_id_)
database:del(bot_id..'Manager'..msg.chat_id_)
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
...
{
{text = '𝐕𝐀𝐌𝐁𝐈𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✹ ', url="t.me/SOURCE_SYRIA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ siria ┉  ┉ ┉ ┉ ┉≫ٴٴ\n※ ➫ .[🖨┇𝐕𝐀𝐌𝐁𝐈𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✹  ](t.me/SOURCE_SYRIA)➤ ')
end
...
if text == "تحب هذا" or text == "بتحب دا" then
